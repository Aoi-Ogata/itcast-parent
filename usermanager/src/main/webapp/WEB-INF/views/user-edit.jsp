...
<div style="padding:10px 10px 10px 10px">
    <form id="content2" method="post">
        ...
        <table cellpadding="5">
            ...
            <tr>
                <td>姓名:</td>
                <td><input class="easyui-textbox" name="name" data-options="validType:'length[0,150]',required:true"
                           style="width: 280px;"></input></td>
            </tr>
            <tr>
                <td>年龄:</td>
                <td><input class="easyui-numberbox" type="text" name="age"
                           data-options="min:1,max:100,precision:0,required:true"/>
                </td>
            </tr>
            <tr>
                <td>性别:</td>
...
<script type="text/javascript">
    function submitForm() {
        if (!$('#content2').form('validate')) {
            $.messager.alert('提示', '表单还未填写完成!');
            return;
        }
        /*		$.post("/rest/user",{'_method':'PUT'},$("#content2").serialize(), function(data,status,xhr){
                    if(xhr.status == 204){
